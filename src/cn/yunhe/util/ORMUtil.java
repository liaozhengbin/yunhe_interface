...
public class ORMUtil {
	...
	public int performDML(String name, Object[] stuArray) {
		return new UtilityClass4().performDML(name, stuArray);
	}
	
	public int performDML_index(String name, Object[] stuArray) {
		return new UtilityClass4().performDML_index(name, stuArray);
	}
	...
	public <T> List<T> selectList(String sql,Object[] paramList,Class<T> clazz){
		...
		//从数据库取出来的mapList
		List<Map<String, Object>> listMap=new UtilityClass4().performDQL(sql, paramList);
